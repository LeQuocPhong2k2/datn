...
export default function Teacher() {
  ...
  return (
    <div className="h-screen max-w-[100%] grid grid-cols-1 font-sans bg-gray-100">
      {toggleMenu && (
        <div
          className={`w-96 h-screen fixed top-0 left-0 bg-white shadow-lg ${toggleMenu ? 'slide-right' : 'slide-left'}`}
        >
          <div
          ...
          >
            <div>
              ...
              <br />
              <span className="text-lg text-gray-700">Chủ nhiệm: 1A1</span>
            </div>
          ...
          <div className="px-5 mt-10">
            ...
            {/* <div className="flex items-center justify-between gap-2">
              ...
              <div className="flex items-center gap-2">
                ...
                {studentList.filter((student) => student.status === 'CM').length} học sinh có mặt
              </div>
              <div className="flex items-center gap-2">
                <i className="fas fa-user-times mr-2"></i>
                {studentList.filter((student) => student.status === 'VCP').length} học sinh vắng có phép
              </div>
            </div> */}

            <ul>
              <li className="px-5 py-2 my-2 text-lg text-black font-semibold border rounded-full hover:bg-gray-300 cursor-pointer">
                <a href="/teacher/attendance-management">
              ...
              <li className="px-5 py-2 my-2 text-lg text-black font-semibold border rounded-full hover:bg-gray-300 cursor-pointer">
                <a href="/teacher/class-management">
              ...
              {/* mục quản lý điểm sô */}
              <li className="px-5 py-2 my-2 text-lg text-black font-semibold border rounded-full hover:bg-gray-300 cursor-pointer">
                <a href="/teacher/grade-management">
                  <i className="fas fa-chart-bar mr-2"></i>
                  Quản lý điểm số
                </a>
              </li>
              ...
              <li className="px-5 py-2 my-2 text-lg text-black font-semibold border rounded-full hover:bg-gray-300 cursor-pointer">
                <a href="/teacher/schedule-management">
