  ...
  async updateTranscript(req, res) {
    ...
    try {
      ...
      if (transcriptUpdate) {
        ...
        transcriptUpdate.hk1Tb = !isNaN(tbhk1Avg)
          ? parseFloat(tbhk1Avg).toFixed(1)
          : ''
        transcriptUpdate.hk2Gk = gk2
        transcriptUpdate.hk2Ck = ck2
        transcriptUpdate.hk2Tb = !isNaN(tbhk2Avg)
          ? parseFloat(tbhk2Avg).toFixed(1)
          : ''
        transcriptUpdate.allYear = !isNaN(tbcnAvg)
          ? parseFloat(tbcnAvg).toFixed(1)
          : ''
